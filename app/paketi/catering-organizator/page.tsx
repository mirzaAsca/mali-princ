...
import { Crown, Phone, Calendar, Star } from "lucide-react";
import Link from "next/link";
import Image from "next/image";

export default function CateringOrganizatorPage() {
  const includes = [
    "Kompletna organizacija i posluživanje hrane za događaje",
    "Personalizovani meni prema vašim željama — 28KM/osobi",
    "Dekoracija stola (u boji i stilu događaja) — 40KM",
    "Profesionalno osoblje za posluživanje — 70KM/sat",
    "Barski stolovi — 25KM/kom",
    "Koordinacija na dan događaja — 50KM/sat",
  ];
  const forWho =
    "Za organizatore događaja, vjenčanja, korporativnih evenata i proslava koji žele kompletnu uslugu bez stresa.";
  const example = "Za 15 osoba — 1065KM";
  const gallery = [
      ...
      <section className="relative py-20 px-4 text-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-luxury mb-3">
            Catering Organizator Sarajevo
          </h1>
          <p className="text-elegant max-w-3xl mx-auto">
            Kompletna organizacija i posluživanje hrane za događaje. Dekor i
            osoblje uključeni. Min. 15 osoba.
          </p>
