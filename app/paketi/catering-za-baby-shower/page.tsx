...
import { Baby, Phone, Calendar, Star } from "lucide-react";
import Link from "next/link";
import Image from "next/image";

export default function CateringBabyShowerPage() {
  const includes = [
  ...
  const example = "Za 15 osoba — 1020KM";
  const gallery = [
    "/gallery/Ketering_board_v2/Ketering_Investitori_v2-2.jpg",
    "/gallery/Ketering_board_v2/Ketering_Investitori_v2-9.jpg",
    "/gallery/Ketering_board_v2/Ketering_Investitori_v2-16.jpg",
  ];
      ...
      <section className="relative py-20 px-4 text-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-luxury mb-3">
            Catering za Baby Shower Sarajevo
          </h1>
          <p className="text-elegant max-w-3xl mx-auto">
            Pastelne dekoracije, candy bar i emotivni detalji za nezaboravan
            trenutak.
          </p>
      ...
      <section className="px-4 pb-24 text-center">
        <div className="max-w-3xl mx-auto glass-card rounded-2xl p-8">
          ...
          <p className="text-elegant mb-6">
            Pošaljite upit i dobijte prijedlog candy bara i dekoracije.
          </p>
